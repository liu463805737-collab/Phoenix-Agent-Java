...
import com.phoenix.data.enums.LlmServiceEnum;
...
public class DataAgentProperties {
	...
	/**
	 * spring.ai.phoenix.data-agent.embedding-batch.encoding-type=cl100k_base
	 * spring.ai.phoenix.data-agent.embedding-batch.max-token-count=2000
	 * spring.ai.phoenix.data-agent.embedding-batch.reserve-percentage=0.2
	 * spring.ai.phoenix.data-agent.embedding-batch.max-text-count=10
	 */
