...
import com.phoenix.data.workflow.node.AabstractNodeAction;
...
import static com.phoenix.data.constant.Constant.TRACE_THREAD_ID;
...
public final class FluxUtil {
	 ...
	 */
	public static Flux<GraphResponse<StreamingOutput>> createStreamingGeneratorWithMessages(String nodeName,
			Class<? extends AabstractNodeAction> nodeClass, OverAllState state, String startMessage, String completionMessage,
	 ...
	 */
	public static Flux<GraphResponse<StreamingOutput>> createStreamingGeneratorWithMessages(String nodeName,
			Class<? extends AabstractNodeAction> nodeClass, OverAllState state,
			Function<String, Map<String, Object>> resultMapper, Flux<ChatResponse> sourceFlux) {
		return createStreamingGeneratorWithMessages(nodeName, nodeClass, state, null, null, resultMapper, sourceFlux);
	}
	 ...
	 * @return Flux instance
	 */
	public static Flux<GraphResponse<StreamingOutput>> createStreamingGenerator(String nodeName, Class<? extends AabstractNodeAction> nodeClass,
