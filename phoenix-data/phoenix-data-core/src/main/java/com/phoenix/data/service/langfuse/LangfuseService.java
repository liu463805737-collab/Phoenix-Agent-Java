package com.phoenix.data.service.langfuse;
...
/**
 * 基于 OpenTelemetry 的 Langfuse 追踪服务，用于记录和追踪 LLM 调用链路及 Token 用量。
 *
 * @author zihenzzz
 * @date 2026/2/16
 */
...
public class LangfuseService {
	...
	/**
	 * 构造 LangfuseService 实例
	 * @param langfuseTracer OpenTelemetry Tracer 实例
