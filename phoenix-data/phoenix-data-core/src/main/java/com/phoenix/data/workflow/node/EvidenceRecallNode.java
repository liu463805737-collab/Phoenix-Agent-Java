...
import com.phoenix.data.dto.prompt.EvidenceQueryRewriteDTO;
...
/**
 * 证据召回节点，根据用户问题重写查询并召回业务知识和智能体知识作为证据。
 */
@Slf4j
@Component
@AllArgsConstructor
public class EvidenceRecallNode extends AabstractNodeAction {
	...
	/**
	 * 执行证据召回流程：重写用户查询，从向量库中召回相关业务知识和智能体知识文档。
	 *
	 * @param state 全局状态
	 * @return 包含证据内容的结果映射
	 */
	...
	public Map<String, Object> apply(OverAllState state) throws Exception {
		...
		Flux<GraphResponse<StreamingOutput>> evidenceFlux = FluxUtil.createStreamingGenerator(this.getChName(), this.getClass(), state,
	...
	/**
	 * 构建格式化证据内容，包含业务知识和智能体知识。
	 * 输出格式如：
	 * 1. [来源: 2025Q3报告-销售数据.md] ...
	 * 2. [来源: 客服FAQ] Q: ... A: ...
	 *
	...
	/**
	 * 文档检索结果记录，包含业务术语文档、智能体知识文档和所有文档。
	 */
