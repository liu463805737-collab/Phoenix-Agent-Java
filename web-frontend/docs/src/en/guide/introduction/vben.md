...
::: info You are reading the documentation for [Phoenix Admin](https://github.com/vbenjs/vue-vben-admin) version `5.0`!

- Phoenix Admin 2.x is currently archived and only receives critical fixes.
- The new version is not compatible with the old version. If you are using the old version (v2, v3), please refer to the [Vue Phoenix Admin 2.x Documentation](https://doc.vvbin.cn).
...
- [Phoenix Admin](https://github.com/vbenjs/vue-vben-admin) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
