...
function head(): HeadConfig[] {
  return [
    ...
    ['meta', { content: 'Phoenix Admin docs', name: 'keywords' }],
...
function pwa(): PwaOptions {
  return {
    ...
    manifest: {
      description:
        'Phoenix Admin is a modern admin dashboard template based on Vue 3. ',
      icons: [
        {
          sizes: '192x192',
