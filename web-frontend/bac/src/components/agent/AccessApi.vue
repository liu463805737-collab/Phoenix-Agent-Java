      ...
      <div class="card">
        <div class="row">
          ...
          <el-switch
            ...
            @change="handleToggle"
          />
          <el-tag v-if="!apiKey" type="info" size="small" class="tag"
            >未生成</el-tag
          >
        </div>
        ...
        <div class="row key-row">
          ...
          <el-button @click="handleCopy" :disabled="!apiKey || !canCopy"
            >复制</el-button
          >
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const resolvedAgentId = computed(() =>
      Number(props.agentId ?? route.params.id),
    );
