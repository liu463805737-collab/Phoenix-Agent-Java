...
const sliderRef = ref<SliderCaptchaActionType | null>(null);
    ...
    <form class="login-form" novalidate @submit.prevent="handleSubmit">
      ...
      <label class="field">
        ...
        <div class="field__control">
          ...
          <span v-if="capsOn" class="field__caps" title="大写锁定已开启">Caps</span>
        </div>
      </label>
